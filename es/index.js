    ...
    if (overflow.adjustX) {
      ...
      if (isFailX(elFuturePos, elRegion, visibleRect)) {
        ...
        if (newPoints[0].charAt(1) === 'c') {
          ...
          XregionReversal = utils.merge(visibleRect, _defineProperty({}, newPoints[0].charAt(1) === 'l' ? 'left' : 'right', getAlignOffset(refNodeRegion, newPoints[1]).left));
        }
    ...
    if (overflow.adjustY) {
      ...
      if (isFailY(elFuturePos, elRegion, visibleRect)) {
        ...
        if (_newPoints[0].charAt(0) === 'c') {
          ...
          YRegionReversal = utils.merge(visibleRect, _defineProperty({}, _newPoints[0].charAt(0) === 't' ? 'top' : 'bottom', getAlignOffset(refNodeRegion, _newPoints[1]).top));
        }
